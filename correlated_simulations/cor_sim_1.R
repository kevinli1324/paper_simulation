...
for(i in 1:100){
  simulation_object <- cor_wrapper(num_clusters = 30, n_experiments = 162, max_group = 8, prop_affec = 1, mean0_vec = real_counts$set1IT002.Time0)
  #t_matrix
  ...
  save(store_list_1, file = paste0(i, "cor_store_list_1.RData"))
