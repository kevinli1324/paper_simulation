...
for(i in 1:100){
  simulation_object <- cor_wrapper(num_clusters = 30, n_experiments = 162, max_group = 8, prop_affec = .25, mean0_vec = real_counts$set1IT002.Time0)
  #t_matrix
  ...
  stan_object <- pca_wrapper(data = logfit_matrix, princomps = 5, clusters = princomps,  method = "kmeans", file = "simple_multivar.stan", optimize = F, chains = 1, iter = 2000)
  ...
  save(store_list_1, file = paste0(i, "cor_store_list_25.RData"))
}